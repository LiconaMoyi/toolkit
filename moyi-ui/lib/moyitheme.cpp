#include "moyitheme.h"
#include "moyitheme_p.h"
#include <QString>
#include <QStringBuilder>
#include <QDebug>


MoyiThemePrivate::MoyiThemePrivate(MoyiTheme *q)
    : q_ptr(q)
{
}

MoyiThemePrivate::~MoyiThemePrivate()
{
}



QColor MoyiThemePrivate::rgba(int r, int g, int b, qreal a) const
{
    QColor color(r, g, b);
    color.setAlphaF(a);
    return color;
...
MoyiTheme::MoyiTheme(QObject *parent)
    : QObject(parent),
      d_ptr(new MoyiThemePrivate(this))
{
...
QColor MoyiTheme::getColor(const QString &key) const
{
    Q_D(const MoyiTheme);
...
void MoyiTheme::setColor(const QString &key, const QColor &color)
{
    Q_D(MoyiTheme);
...
void MoyiTheme::setColor(const QString &key, Material::Color color)
{
    Q_D(MoyiTheme);
...
QIcon MoyiTheme::icon(QString category, QString icon)
{
